// Kevin Ramirez
// Section 104 - Singly Linked List: Implement reverse() function
...
class LinkedList
{
  ...
  reverse()
  {
    ...
    this.tail = this.head; // Makes the head node the tail node
    ...
    while(second)
    {
      ...
      second.next = first;
      first = second;
      second = temp; // Loop to the next node
    }
...
const myList = new LinkedList(1); // Creates new LL with head value of 10
